...
QtObject {
    // [General]
    property string activeMonitorName: "" // @internal
    property real generalScale: scaleForMonitor(activeMonitorName) // @config:"scale" @default:1.0 @desc:Overall scale of the UI. A positive value in the [PerMonitorScale] section for the active monitor takes precedence. This option can cause the UI to break, so it is recommended to use the individual width/height/size options instead.
    property bool enableAnimations: config['enable-animations'] === "false" ? false : true // @desc:Enable or disable all animations.

    function scaleForMonitor(monitorName) {
        var monitorScale = monitorName.length > 0
            ? config.realValue("PerMonitorScale/" + monitorName)
            : 0.0;
        return monitorScale > 0.0 ? monitorScale : (config.realValue("scale") || 1.0);
    }
    ...
    property string clockFontFamily: config.stringValue("LockScreen.Clock/font-family") || "Noto Sans" // @desc:Font family used for the clock.
    ...
    property string dateFontFamily: config.stringValue("LockScreen.Date/font-family") || "Noto Sans" // @desc:Font family used for the date.
    ...
    property string lockMessageFontFamily: config.stringValue("LockScreen.Message/font-family") || "Noto Sans" // @desc:Font family used for the custom message.
    ...
    property string usernameFontFamily: config.stringValue("LoginScreen.LoginArea.Username/font-family") || "Noto Sans" // @desc:Font family used for the username.
    ...
    property string passwordInputFontFamily: config.stringValue("LoginScreen.LoginArea.PasswordInput/font-family") || "Noto Sans" // @desc:Font family of the password field.
    ...
    property string loginButtonFontFamily: config.stringValue("LoginScreen.LoginArea.LoginButton/font-family") || "Noto Sans" // @desc:Font family of the label of the login button/
    ...
    property string spinnerFontFamily: config.stringValue("LoginScreen.LoginArea.Spinner/font-family") || "Noto Sans" // @desc:Font family of the text to be displayed with the spinning icon.
    ...
    property string warningMessageFontFamily: config.stringValue("LoginScreen.LoginArea.WarningMessage/font-family") || "Noto Sans" // @desc:Font family of the warning message.
    ...
    property string menuAreaButtonsFontFamily: config.stringValue("LoginScreen.MenuArea.Buttons/font-family") || "Noto Sans" // @desc:Font family of the menu buttons.
    ...
    property string menuAreaPopupsFontFamily: config.stringValue("LoginScreen.MenuArea.Popups/font-family") || "Noto Sans" // @desc:Font family of the popups.
    ...
    property string tooltipsFontFamily: config.stringValue("Tooltips/font-family") || "Noto Sans" // @desc:Font family of the tooltips.
